    ...
    <div id="layanan" class="bg-white pt-10 pb-24">
        <div class="max-w-7xl mx-auto px-8">
            ...
            <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <!-- Percetakan -->
                <div
                    class="text-center bg-white p-8 rounded-xl transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-gradient-to-br hover:from-pink-50 hover:to-red-50">
